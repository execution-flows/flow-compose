...
class TestFlowWithFunctionArgumentDefaultValue(unittest.IsolatedAsyncioTestCase):
    async def test_flow_with_function_argument_default_value(self) -> None:
        with self.assertRaisesRegex(
            ...
            async def hello_world(greeting="Hello World!") -> None:
                pass
