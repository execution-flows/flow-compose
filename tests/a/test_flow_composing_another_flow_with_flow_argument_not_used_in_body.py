...
@flow_function()
async def greeting_hello_world(index: FlowFunction[int]) -> str:
...
class TestFlowComposingAnotherFlowWithFlowArgumentNotUsedInBody(
    unittest.IsolatedAsyncioTestCase
):
    async def test_flow_composing_another_flow_with_flow_argument_not_used_in_body(
        self,
    ):
