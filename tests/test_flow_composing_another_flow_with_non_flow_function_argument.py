...
def hello_world_greeting(index: int, greeting: FlowFunction[str]) -> str:
...
class TestFlowComposingAnotherFlowWithNonFlowFunctionArgument(unittest.TestCase):
    def test_flow_composing_another_flow_with_non_flow_function_argument(self):
        hello_world()
